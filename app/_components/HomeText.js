            ...
            < div className='flexCenter  flex-col paddingXBody ' >
              ...
              >
                <div className="heading2 ">
                  <div className={`${animations.goDown2} ${leaveAnimation ? animations.leavePage3 : ""}`}> <p className='text-secondary dark:text-primary'>I'm a full stack developer</p></div>
                  <div className={`${animations.goDown1} ${leaveAnimation ? animations.leavePage4 : ""}`}> <p className='text-secondary dark:text-primary'>& an addict to learning</p></div>
                </div></div >

            </div>

            {/*BOTTONS*/}
            <div className={` md:flexCenter max-md:flexCol xl:gap-[50px] gap-[8px] pt-[60px] ${animations.goUp} paddingXBody ${leaveAnimation ? animations.leavePageUp : ""}`} >
