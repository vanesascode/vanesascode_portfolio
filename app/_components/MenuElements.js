      ...
      {showMenu && (
        ...
        <div className='h-screen flexCenter '>
          ...
          <div className="flex justify-start items-start flex-col gap-5 w-[200px] md:w-[500px] xl:w-[1000px]">
            ...
            <a href="/" >
              <div className={`heading1 ${lightMode === "light" ? "linksUnderlinesMenuWhite" : "linksUnderlinesMenuBlack"} relative ${animations.goDown4} cursor-pointer ${leaveAnimation ? animations.leavePage1 : ""}`} onClick={() => {
                setTimeout(() => {
            ...
            <Link href="/projects">
              <div className={`heading1 ${lightMode === "light" ? "linksUnderlinesMenuWhite" : "linksUnderlinesMenuBlack"} relative ${animations.goDown3} cursor-pointer ${leaveAnimation ? animations.leavePage2 : ""}`} onClick={() => {
                setTimeout(() => {
                  setShowMenu(false);
                }, 500);
              }}>
            ...
            <Link href="/about">
              <div className={`heading1 ${lightMode === "light" ? "linksUnderlinesMenuWhite" : "linksUnderlinesMenuBlack"} relative ${animations.goDown2} cursor-pointer ${leaveAnimation ? animations.leavePage3 : ""}`} onClick={() => {
                setTimeout(() => {
                  setShowMenu(false);
            ...
            <Link href="/contact">
              <div className={`heading1 ${lightMode === "light" ? "linksUnderlinesMenuWhite" : "linksUnderlinesMenuBlack"} relative ${animations.goDown1} cursor-pointer ${leaveAnimation ? animations.leavePage4 : ""}`} onClick={() => {
                setTimeout(() => {
                  setShowMenu(false);
